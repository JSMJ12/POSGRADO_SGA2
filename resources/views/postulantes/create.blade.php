                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select" id="maestria_id" name="maestria_id" required style="width: 100%;">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        @error('dni')
                                            @if ($message == 'The dni field is required.') {{-- Verificar si el error es por omisión --}}
                                                <div class="alert alert-danger">
                                                    <strong>Error:</strong> El campo de cédula o pasaporte es obligatorio.
                                                </div>
                                            @else {{-- Si no es por omisión, asumir que es por duplicidad --}}
                                                <div class="alert alert-danger">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" name="correo_electronico" class="form-control" placeholder="correo@example.com" required>
                                        @error('correo_electronico')
                                            ...
                                            @else 
                                                <div class="alert alert-danger">
                                                    <strong>Error:</strong> Ya has realizado una postulación previamente con este correo electrónico.
                                                </div>
                                            @endif
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="universidad_titulo" class="form-control" placeholder="Nombre de la universidad">
                                    </div>
                                    <br>
                                    <div class="form-group">
